...
class PatientRequestHistoryScreen extends StatelessWidget {
  final String doctorId;
  final String patientId;
  final String patientName;

  const PatientRequestHistoryScreen(
      {super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final String effectiveDoctorId = doctorId.isNotEmpty
        ? doctorId
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Requests by $patientName'),
        centerTitle: true,
        elevation: 0.5,
      ),
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => DoctorRequestDetailScreen(
                            requestId: docs[index].id, doctorName: 'Doctor'),
                      ),
                    );
                  },
                  title: Row(
